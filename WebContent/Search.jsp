...
<%			
	...
	<table align="center" id="grid" style="text-align: left; width: 80%">
	<tr>
	<%
		try{
			...
			db.rs = db.st.executeQuery("select * from advertisement where name like '%"+search+"%' or location like '%"+search+"%'");
